...
| `CONFORMANCE_PROFILE_UNSATISFIED` | 500 | FATAL | A named `conformance_profile` requires something the deployment has not configured; `aarm` requires an Agent Manifest binding (AARM R6) | [STATUS.md](https://github.com/agentrust-io/cmcp/blob/main/STATUS.md) |
